...
function Input(props) {
  ...
  return (
    ...
    <div className={styles.name} style={props.style || {}}  {...props}>
      ...
      {props.isRequired ?
        <input className={`${styles.input} ${props.isValid ? '' : styles.invalid}`} id={props.id} type={props.type??'text'} onChange={props.onChange} min={props.min} max={props.max} required />
